...
# 2. THE MASTER CATALOG: Verified IDs and Your Direct Links
PRODUCTS = [
    ...
    ["Sony WH-1000XM5 Headphones", "UZvUH8tejj8", "https://amzn.to/4jVxwoK"], # Verified Sony Link
...
def run_sifter():
    ...
    try:
        ...
        # Using raw HTML for the button ensures target="_blank" works in Jekyll
        post_content = f"""---
layout: post
...
### The Sift Verdict
The **{product_name}** represents the premium standard for a professional workspace. 
...
"""
        ...
        print(f"✅ Post generated successfully for: {product_name}")
